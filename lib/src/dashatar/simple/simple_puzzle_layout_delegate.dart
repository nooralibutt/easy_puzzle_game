...
/// {@endtemplate}
class MySimplePuzzleLayoutDelegate extends PuzzleLayoutDelegate {
    ...
    return Positioned(
      ...
      child: ResponsiveLayoutBuilder(
        ...
        medium: (_, __) => SizedBox(
          ...
          height: 214,
          child: Image.asset(
            'assets/images/dashatar/simple_dash_medium.png',
        ...
        large: (_, __) => Padding(
          ...
          child: SizedBox(
            ...
            height: 320,
            child: Image.asset(
              'assets/images/dashatar/simple_dash_large.png',
...
class SimplePuzzleShuffleButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PuzzleButton(
      ...
      onPressed: () => context.read<MyPuzzleBloc>().add(const PuzzleReset()),
      child: Row(
