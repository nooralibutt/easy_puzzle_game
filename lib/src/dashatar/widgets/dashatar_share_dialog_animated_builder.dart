...
class MyDashatarShareDialogAnimatedBuilder extends StatelessWidget {
  const MyDashatarShareDialogAnimatedBuilder({
    Key? key,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          MyDashatarShareDialogEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
  MyDashatarShareDialogEnterAnimation animation,
);

class MyDashatarShareDialogEnterAnimation {
  MyDashatarShareDialogEnterAnimation(this.controller)
